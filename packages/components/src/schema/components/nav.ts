...
import type { PropCollapsible, PropHasCompactButton, PropHasIconsWhenExpanded, PropHideLabel, PropLabel, PropNavBehavior } from '../props';
...
type OptionalProps = PropCollapsible & PropHasCompactButton & PropHasIconsWhenExpanded & PropHideLabel & PropOrientation & PropNavBehavior;
...
type RequiredStates = {
	...
	PropLabel &
	PropOrientation;
type OptionalStates = PropNavBehavior & NonNullable<unknown>;
