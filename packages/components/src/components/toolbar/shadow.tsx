...
import type { LabelPropType, ToolbarAPI, ToolbarStates, ToolbarItemsPropType, ToolbarItemPropType } from '@public-ui/schema';
import { validateLabel, validateToolbarItems } from '@public-ui/schema';
