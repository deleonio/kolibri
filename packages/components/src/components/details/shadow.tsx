...
import type { DetailsAPI, DetailsCallbacksPropType, DetailsStates, DisabledPropType, FocusableElement, HeadingLevel, LabelPropType } from '@public-ui/schema';
import { validateDetailsCallbacks, validateDisabled, validateLabel, validateOpen } from '@public-ui/schema';
