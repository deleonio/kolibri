import type { AutoCompletePropType, InputColorProps, InputColorWatches, SuggestionsPropType } from '@public-ui/schema';
import { validateSuggestions, watchString } from '@public-ui/schema';
